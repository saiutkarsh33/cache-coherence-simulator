...
def main():
    ...
    print(f"{'Benchmark':18} {'Loads':>8} {'Stores':>8} {'Hits':>10} {'Misses':>10} {'HitRate':>8} {'ExecCycles':>12} {'BusBytes':>12}")
    print("-"*95)
    ...
    for path in files:
        ...
        print(f"{name:18} {loads:8d} {stores:8d} {hits:10d} {misses:10d} {hr:8.2%} {execc:12d} {bus:12d}")
